        ...
        actions: () => {
            const actions = [
                ...
                },
                {
                    ...
                    templateFile:
                        "./config/plop/component/component.test.tsx.plop",
                },
            ];
        ...
        prompts: [
            {
                ...
                message:
                    ...
                    'Name of your reducer (e.g. "Calendar Event" or "Vehicle")',
            },
        ],
        actions: () => {
            const actions = [
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/actions.ts",
                    templateFile: "./config/plop/reducer/actions.ts.plop",
                },
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/actions.test.ts",
                    templateFile: "./config/plop/reducer/actions.test.js.plop",
                },
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/reducer.ts",
                    templateFile: "./config/plop/reducer/reducer.ts.plop",
                },
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/reducer.test.ts",
                    templateFile: "./config/plop/reducer/reducer.test.js.plop",
                },
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/selectors.ts",
                ...
                },
                {
                    ...
                    templateFile:
                        "./config/plop/reducer/selectors.test.js.plop",
                },
                {
                    type: "pretty-add",
                    path:
                        "./src/shared/store/{{camelCase reducerName}}/types.ts",
